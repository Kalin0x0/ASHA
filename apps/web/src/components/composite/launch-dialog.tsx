...
import { Download, Globe, Loader2, Monitor, Play } from 'lucide-react';
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="mt-1.5 flex items-start gap-1.5 text-[12px] text-muted-foreground">
              {mode === 'web' ? <Globe className="mt-0.5 size-3.5 shrink-0" /> : <Monitor className="mt-0.5 size-3.5 shrink-0" />}
              <span>{mode === 'web' ? t('webNativeHint') : t('rdpClientHint')}</span>
            </p>
          </div>
