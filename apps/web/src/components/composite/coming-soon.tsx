      ...
      <div className="relative flex flex-col items-center gap-7 px-6 py-28 text-center animate-fade-up">
        ...
        <div className="relative flex items-end justify-center animate-float">
          <Image
            ...
            height={512}
            unoptimized
            className="size-[60px] opacity-20"
          />
          <span className="absolute -bottom-2 -end-2 flex size-11 items-center justify-center rounded-xl border border-gold-500/30 bg-gold-500/10 text-gold-300 shadow-[0_0_20px_-4px_rgb(var(--brand-rgb)/0.3)] ring-1 ring-inset ring-white/5">
