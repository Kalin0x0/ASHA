  ...
  return (
    <DialogPrimitive.Root open={commandOpen} onOpenChange={setCommandOpen}>
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content className="gold-hairline glass-strong fixed left-1/2 top-[14%] z-modal w-full max-w-xl -translate-x-1/2 overflow-hidden rounded-2xl border border-border-subtle shadow-[var(--shadow-lifted),0_0_0_1px_rgb(var(--brand-rgb)/0.07)] data-[state=open]:animate-rise">
