...
export const useStopObservation = impl.useStopObservation;
...
export const useSetWorkspaceUserAccess = impl.useSetWorkspaceUserAccess;
export const useSetWorkspaceGroupAccess = impl.useSetWorkspaceGroupAccess;
export const useIsolationDenyByDefault = impl.useIsolationDenyByDefault;
...
export const useDeleteFeedback = impl.useDeleteFeedback;
...
export const useDeleteBug = impl.useDeleteBug;
