...
export const BACKGROUNDS: readonly BackgroundPreset[] = [
  ...
  // ── Colour blooms ──────────────────────────────────────────────────────────
  {
    id: 'aurora',
    image:
      'radial-gradient(60% 55% at 18% 20%, rgb(var(--brand-rgb)/0.18), transparent 60%),' +
      ...
      'radial-gradient(72% 62% at 38% 108%, rgb(var(--brand-rgb)/0.10), transparent 72%)',
    grid: true,
  },
  {
    id: 'ember',
    image:
      ...
      'radial-gradient(70% 60% at 45% 110%, rgb(var(--brand-rgb)/0.14), transparent 70%)',
    grid: true,
  },
  {
    id: 'nebula',
  ...
  },
  {
    ...
    image:
      ...
      'radial-gradient(70% 60% at 45% 110%, rgb(var(--brand-rgb)/0.08), transparent 70%)',
    grid: true,
  },
  {
    id: 'crimson',
  ...
  },
  {
    id: 'graphite',
    image:
      'radial-gradient(70% 60% at 30% 12%, rgb(var(--brand-rgb)/0.07), transparent 66%),' +
